  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card title="Planning" icon={<AceternityIcon order="Phase 1" />} des="aaaaaaaaaaaaaaaaaaaaaaaaaaaa">
          <EvervaultCard />
        </Card>
        <Card title="Planning 2" icon={<AceternityIcon order="Phase 2" />} des="saaaaaaaaaaaaaaaaaaaaaaaaaaaa">
          <EvervaultCard />
        </Card>
        <Card title="Planning 3" icon={<AceternityIcon order="Phase 3" />} des="saaaaaaaaaaaaaaaaaa">
          <EvervaultCard />
        </Card>
      </div>
    </section>
...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      <button className="relative inline-flex overflow-hidden rounded-full p-[1px] pointer-events-none">
        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite]
          bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)] pointer-events-none" />
